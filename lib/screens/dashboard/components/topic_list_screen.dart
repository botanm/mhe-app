...
class TopicListScreen extends StatefulWidget {
  static const routeName = '/topiclist';
...
class _TopicListScreenState extends State<TopicListScreen> {
  ...
  Widget build(BuildContext context) {
    print('*************** topic_list_screen build ***************');
    final List<dynamic> allElement = getPrioritizedElements(bpr.topics);
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, index) => BasicsRUDListTile(
          ...
          onViewHandler: () {
            ...
            Utils.showNewScreen(context, args, NewTopicScreen.routeName,
                NewTopicScreen(args: args));
          },
          onEditHandler: () {
            final Map<String, dynamic> args = {
              'editedId': elements[index]['id'],
