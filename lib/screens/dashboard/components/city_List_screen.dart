...
class _CityListScreenState extends State<CityListScreen> {
  ...
  Widget build(BuildContext context) {
    print('*************** city_list_screen build ***************');
    final List<dynamic> allElement = getPrioritizedElements(bpr.cities);
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, index) => BasicsRUDListTile(
          ...
          onViewHandler: () {
            ...
            Utils.showNewScreen(context, args, NewCityScreen.routeName,
                NewCityScreen(args: args));
          },
          onEditHandler: () {
            final Map<String, dynamic> args = {
              'editedId': elements[index]['id'],
    ...
    return BasicsListAppBar(
      onAddHandler: () {
        if (isSmallSizeScreen) {
          Navigator.pushNamed(context, NewCityScreen.routeName);
        } else {
          showDialog(
