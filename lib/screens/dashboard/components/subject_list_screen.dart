...
class SubjectListScreen extends StatefulWidget {
  static const routeName = '/subjectlist';
...
class _SubjectListScreenState extends State<SubjectListScreen> {
  ...
  Widget build(BuildContext context) {
    print('*************** subject_list_screen build ***************');
    final List<dynamic> allElement = getPrioritizedElements(bpr.subjects);
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, index) => BasicsRUDListTile(
          ...
          onViewHandler: () {
            ...
            Utils.showNewScreen(context, args, NewSubjectScreen.routeName,
                NewSubjectScreen(args: args));
          },
          onEditHandler: () {
            final Map<String, dynamic> args = {
              'editedId': elements[index]['id'],
    ...
    return BasicsListAppBar(
      onAddHandler: () {
        if (isSmallSizeScreen) {
          Navigator.pushNamed(context, NewSubjectScreen.routeName);
        } else {
          showDialog(
